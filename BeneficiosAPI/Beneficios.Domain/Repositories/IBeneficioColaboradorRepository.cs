...
public interface IBeneficioColaboradorRepository
{
    ...
    /// </summary>
    /// <param name="beneficioColaborador">O colaborador ao qual os benefícios serão associados.</param>
    /// <param name="cancellationToken">Token para cancelar a operação.</param>
    /// <returns>O colaborador atualizado com os benefícios incluídos.</returns>
    Task<BeneficioColaborador> IncluirBeneficiosAoColaborador(BeneficioColaborador beneficioColaborador, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken">Token para cancelar a operação.</param>
    /// <returns>O colaborador encontrado com seus benefícios ou <c>null</c> se não encontrado.</returns>
    Task<BeneficioColaborador?> ObterColaboradorComBeneficiosPorId(long idColaborador, CancellationToken cancellationToken);
    ...
    Task<BeneficioColaborador> AtualizarBeneficiosDoColaborador(long idColaborador, List<Beneficio> beneficios, CancellationToken cancellationToken);
    ...
    Task<BeneficioColaborador> RemoverBeneficioDoColaborador(long idColaborador, string nomeBeneficio, CancellationToken cancellationToken);
    ...
    Task<IEnumerable<BeneficioColaborador>> ObterTodosColaboradoresComBeneficios(CancellationToken cancellationToken);
}
